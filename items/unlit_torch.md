...
<div style="flex: 1;">  
<p>An unlit torch cannot be placed as a block and does not emit light. It has a durability bar which indicates how much longer it can burn for, when turned into a lit torch.</p>
</div>  
	
<div style="width: 250px; border: 2px solid #3a3a3a; font-family: sans-serif;">  
<!-- TITLE -->  
<div style="background-color: #3a3a3a; color: white; padding: 6px; font-weight: bold; text-align: center;">Unlit Torch</div>  
