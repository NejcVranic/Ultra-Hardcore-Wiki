...
<div style="flex: 1;">  
<p>When used, the player will be shown their hidden nutrition scores (Protein, Carbs and Micronutrients) through the chat box.</p>
</div>  
	
<div style="width: 250px; border: 2px solid #3a3a3a; font-family: sans-serif;">  
<!-- TITLE -->  
<div style="background-color: #3a3a3a; color: white; padding: 6px; font-weight: bold; text-align: center;">Nutrition Monitor</div>  
