...
- try to get 1 raw iron, 1 leather, 2 planks, 16 clay and 3 sand by the end of the first two days
...
You're gonna start running out of hydration very soon, so your goal for today is to obtain a furnace and crafting table. You'll need both to make water bottles and regain hydration. You can eat apples, sweet berries and watermelon to regain a little hydration, but they only buy you a few minutes of time. 

You need to find 1 leather, 1 iron ore, get 16 bricks to craft a furnace and 2 planks for the crafting table recipe. You may choose to craft leather using rabbit hide instead of finding and killing cows or horses. You can easily catch rabbits by making a snare trap and putting it in the forest floor, although this method will require some time and resources.

Smelt clay balls into bricks and craft a furnace from 4 brick blocks.
...
1. [Frost](./survival_systems/frost.md): at night you are confined to standing near a source of heat. If you wear any leather armor or any 4 pieces of armor you won't freeze at night anymore. 
...
The better materials can only be obtained after going to the nether. You'll have to make the portal using water and lava buckets. Your hydration depletes very quickly in the Nether dimension, so you'll need to bring water bottles or canteens with you. Once in the nether you have access to netherrack, which you can use to make regular torches (which don't burn out) and lanterns. It's also an easy place to find gold, which you can use to make [glistening honey](./items/glistening_honey.md) (replaces bandages). You can even start looking for a nether fortress, tho I'd recommend getting better armor and weapons before that. You should strongly consider getting a [hydrating helmet](./items/hydrating_helmet.md) before exploring the nether.
...
If you decide to get a hydrating helmet you'll have to raid an ocean monument for the wet sponge required. This should be a "fun" (big) challenge with only steel gear available to you. You can now find ocean monument maps in shipwreck chests (~60%).
 ...
 Collect blaze rods, nether wart, netherrack and some blackstone. You can then make a [nether forge](./blocks/nether_forge.md) which allows you to make blaze gold, diamond and netherite gear.
...
Unless you find melon slices or sweet berries apples are your best bet early on. You can make cactus juice if you find cactus and sugar cane. You can also make squid stew by killing squid, but use caution...

To actually solve the (de)hydration problem you need to make (filtered) bottles of water. To make bottles you need glass, which you can make by smelting sand using a furnace, which you don't have. You can make a furnace with 4 brick blocks, but to get the bricks required you need to smelt clay balls. You can smelt them in a furnace OR by putting in to cook on a campfire.

Make a furnace and smelt sand to glass. Make bottles and fill them with water. You might get hunger or poison effect if you drink a regular bottle of water. You should boil the bottles of water on a campfire for 30 seconds until they start making bubbling sounds. The filtered water bottles are safe to drink.

Carrying bottles around is annoying because they clog up the inventory. You can make a canteen which can be drank from multiple times before needing a refill. (Don't forget the water still needs to be made safe to drink! You can also fill the canteen with safe to drink water by refilling it on water above a magma block or cauldron above a fire.)

Maintaining hydrating manually is still annoying. You can make a Hydrating helmet (which will passively increase your hydration) using 2 buckets, iron ingots and a wet sponge. Wet sponges aren't that easy to come around... you'll have to loot an ocean monument to get some. Well... good luck! At least the rewards are worth it now.
...
The player is encouraged to eat a health diet. Generally, it's recommended you find and eat many different foods. The best way to manage your nutrition in the early game is by simply eating as many different foods as possible. The easiest way to do this is by eating different types of meat, on rotation.
